...
export const LEVELS = [
    // ── Level 1: Introduction ──
    {
        ...
        waves: [
            ...
            { enemies: [
                ...
                { type: 'muddleCloud', lane: 2, delay: 2 },
            ]},
            { enemies: [
                { type: 'muddleCloud', lane: 0, delay: 0 },
                { type: 'muddleCloud', lane: 1, delay: 1 },
                { type: 'muddleCloud', lane: 2, delay: 2 },
            ]},
        ],
        stickerReward: 'star',
    ...
    // ── Level 2: Colors ──
    {
        ...
        waves: [
            ...
            { enemies: [
                { type: 'muddleCloud', lane: 0, delay: 0 },
                { type: 'muddleCloud', lane: 1, delay: 0.5 },
                { type: 'muddleCloud', lane: 2, delay: 1 },
            ]},
            { enemies: [
                { type: 'messMonster', lane: 1, delay: 0 },
                { type: 'muddleCloud', lane: 0, delay: 1 },
                { type: 'muddleCloud', lane: 2, delay: 1.5 },
            ]},
        ],
    ...
    // ── Level 3: Letters ──
    {
        ...
        waves: [
            { enemies: [
                { type: 'muddleCloud', lane: 0, delay: 0 },
                { type: 'muddleCloud', lane: 2, delay: 0 },
            ]},
            { enemies: [
                { type: 'messMonster', lane: 1, delay: 0 },
                { type: 'muddleCloud', lane: 0, delay: 1 },
            ...
            { enemies: [
                ...
                { type: 'muddleCloud', lane: 1, delay: 0.5 },
                { type: 'messMonster', lane: 2, delay: 1 },
            ]},
            { enemies: [
                { type: 'muddleCloud', lane: 0, delay: 0 },
                { type: 'muddleCloud', lane: 1, delay: 0 },
                { type: 'muddleCloud', lane: 2, delay: 0 },
    ...
    // ── Level 4: Shapes ──
    {
        ...
        waves: [
            ...
            { enemies: [
                ...
                { type: 'muddleCloud', lane: 0, delay: 2 },
                { type: 'muddleCloud', lane: 2, delay: 2 },
            ]},
            { enemies: [
                { type: 'messMonster', lane: 0, delay: 0 },
                { type: 'messMonster', lane: 2, delay: 0 },
                { type: 'sleepySnail', lane: 1, delay: 1 },
            ]},
            { enemies: [
                { type: 'muddleCloud', lane: 0, delay: 0 },
                { type: 'muddleCloud', lane: 1, delay: 0 },
                { type: 'muddleCloud', lane: 2, delay: 0 },
                { type: 'messMonster', lane: 0, delay: 2 },
                { type: 'messMonster', lane: 2, delay: 2 },
            ]},
        ],
        stickerReward: 'check',
    },
    // ── Level 5: Patterns (Boss!) ──
    {
        ...
        waves: [
            ...
            { enemies: [
                ...
                { type: 'gigglyGremlin', lane: 1, delay: 0.3 },
                { type: 'gigglyGremlin', lane: 2, delay: 0.6 },
                { type: 'gigglyGremlin', lane: 0, delay: 1 },
                { type: 'gigglyGremlin', lane: 2, delay: 1.3 },
            ]},
            { enemies: [
                { type: 'messMonster', lane: 0, delay: 0 },
                { type: 'messMonster', lane: 2, delay: 0 },
                { type: 'bubbleTrouble', lane: 1, delay: 1 },
            ]},
            { enemies: [
    ...
    // ── Level 6: Music ──
    {
        ...
        waves: [
            ...
            { enemies: [
                ...
                { type: 'messMonster', lane: 1, delay: 0 },
                { type: 'messMonster', lane: 2, delay: 0 },
                { type: 'bubbleTrouble', lane: 0, delay: 2 },
                { type: 'bubbleTrouble', lane: 2, delay: 2 },
            ]},
            { enemies: [
                { type: 'kingChaos', lane: 1, delay: 0 },
                { type: 'messMonster', lane: 0, delay: 1 },
                { type: 'messMonster', lane: 2, delay: 1 },
                { type: 'gigglyGremlin', lane: 0, delay: 3 },
                { type: 'gigglyGremlin', lane: 1, delay: 3 },
